...
import styles from "./person-frame.module.css";
import type { TPersonFrameUIPorps } from "./types";
...
export const PersonFrameUI: FC<TPersonFrameUIPorps> = ({ appearance }) => {
  const { direction, size, image, caption } = appearance;
  ...
  return (
    <div
      id="person-frame"
      className={clsx(
        styles["person__frame"],
        styles[`person__frame_${size}`],
        styles[`person__frame_${direction}-top`],
